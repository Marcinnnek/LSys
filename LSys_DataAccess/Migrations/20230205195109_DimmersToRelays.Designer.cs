...
namespace LSys_DataAccess.Migrations
{
    ...
    [Migration("20230205195109_DimmersToRelays")]
    partial class DimmersToRelays
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LSys_Domain.Entities.Relays.RelaySchedulerList", b =>
                {
                    ...
                    b.HasKey("SchedulerId", "RelayId");

                    b.HasIndex("RelayId");

                    b.ToTable("RelaySchedulerList");
                });

            modelBuilder.Entity("LSys_Domain.Entities.Schedulers.Relay", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("FirstChannelState")
                        .HasColumnType("bit");

                    b.Property<bool>("FourthChannelState")
                        .HasColumnType("bit");

                    b.Property<bool>("SecondChannelState")
                        .HasColumnType("bit");

                    b.Property<bool>("ThirdChannelState")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("LSys_Domain.Entities.Relays.RelaySchedulerList", b =>
                {
                    b.HasOne("LSys_Domain.Entities.Schedulers.Relay", "Relay")
                        .WithMany()
